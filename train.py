...
if __name__ == "__main__":
    ...
    parser.add_argument('--baseroot_train', type = str, \
        default = 'E:\\QuadBayer Deblur\\data\\train', \
            help = 'input image baseroot')
    parser.add_argument('--baseroot_train_blur_patch', type = str, \
        default = 'E:\\QuadBayer Deblur\\data\\train', \
            help = 'input image baseroot')
    parser.add_argument('--baseroot_train_salient_patch', type = str, \
        default = 'E:\\QuadBayer Deblur\\data\\train', \
            help = 'input image baseroot')
    parser.add_argument('--baseroot_train_joint_patch', type = str, \
        default = 'E:\\QuadBayer Deblur\\data\\train', \
            help = 'input image baseroot')
    parser.add_argument('--baseroot_val', type = str, \
        default = 'E:\\QuadBayer Deblur\\data\\val', \
            help = 'output image baseroot')
    parser.add_argument('--crop_size', type = int, default = 320, help = 'crop_size')
    parser.add_argument('--num_input', type = list, default = [1, 1, 1, 1], help = 'number of different input')
